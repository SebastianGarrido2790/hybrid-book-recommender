...
class ConfigurationManager:
    """
    Manages project configurations and parameters for the MLOps pipeline.
    ...
    strictly-typed Configuration Entities, providing a robust and reproducible
    ...
    def get_batch_prediction_config(self) -> BatchPredictionConfig:
        ...
        try:
            ...
            return batch_prediction_config
        except Exception as e:
            raise CustomException(e, sys)
